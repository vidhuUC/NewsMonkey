...
export class News extends Component {
    ...
    handleNextClick = async () => {
        ...
        const url = `https://newsapi.org/v2/top-headlines?country=${this.props.country}&apiKey=e8bb0c5899e843249c337710b7d8ebe1&page=${this.state.page + 1}&pageSize=${this.props.pageSize}`
    ...
    async componentDidMount() {
        this.setState({ loading: true })
        const url = `https://newsapi.org/v2/top-headlines?country=${this.props.country}&apiKey=e8bb0c5899e843249c337710b7d8ebe1&page=${this.state.page}&pageSize=${this.props.pageSize}`;
        const data = await fetch(url);
        const parsedData = await data.json();
        this.setState({ loading: false })
